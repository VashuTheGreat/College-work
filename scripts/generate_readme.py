...
README_CONTENT = """# Affecting Machine Flexibility (AMF) — Feature Selection Research
...
def main():
    ...
    print(f"Writing updated README template to {readme_path}")
    with open(readme_path, 'w', encoding='utf-8') as f:
        f.write(README_CONTENT)

    print(f"Writing updated amf_re.md template to {notebook_readme_path}")
    # Replace the image references to be relative to the notebook folder
    notebook_content = README_CONTENT.replace("references/", "../references/")
    with open(notebook_readme_path, 'w', encoding='utf-8') as f:
